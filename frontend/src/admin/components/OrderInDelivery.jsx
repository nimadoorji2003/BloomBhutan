// src/components/OrderInDelivery.js
import React, { useState } from 'react'; // Ensure useState is imported
import Sidebar from "./Sidebar";
import "../styles/OrderInDelivery.css"; // Import the CSS file for OrderInDelivery

const OrderInDelivery = () => {
            ...
            {showChangeStatus && (
                <div className="popup">
                    <div className="popup-change">
                        ...
                        <br />
                        <p>Change it to Order Completed ?</p>
...
export default OrderInDelivery;
